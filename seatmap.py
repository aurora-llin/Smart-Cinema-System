...
# #test
# print(load_seatmap("A", "10:00"))
#print(is_seat_available(load_seatmap("A", "10:00"), get_row_index("A"), get_col_index(1)))
#print(update_seat(load_seatmap("A", "10:00"), get_row_index("A"), get_col_index(1), "X"))
